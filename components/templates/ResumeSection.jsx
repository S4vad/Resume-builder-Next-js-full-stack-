...
// CertificationInfo
export const CertificationInfo = ({ title, year, bgColor }) => (
  <div className="mb-4">
...
export const ContactInfo = ({ icon, iconBG, value }) => (
  <div className="flex items-center gap-3 mb-3">
    ...
    <p className="flex-1 text-sm font-medium break-all text-gray-700">
      {value}
    </p>
  </div>
);
...
export const WorkExperience = ({
  ...
  <div className="mb-6">
    <div className="flex items-start justify-between mb-2">
      <div>
        <h3 className="text-base font-semibold pb-2 text-gray-900">
          {company}
        </h3>
